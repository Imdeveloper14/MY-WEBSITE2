  ...
  return (
    <>
      ...
      {showLoader && (
        ...
        >
          <div className="text-center flex flex-col items-center justify-center gap-16 p-4 max-w-full overflow-hidden">
            {/* Logo Icon Only - Doubled again (h-[280px]), highly bright, intense bloom drop shadow */}
            <img
              src="images/logo_icon.png"
              alt="Primelisometrics Symbol"
              className="h-[180px] sm:h-[240px] md:h-[280px] w-auto object-contain mx-auto transition-all duration-300 filter drop-shadow-[0_0_35px_rgba(220,20,60,0.85)] brightness-150 contrast-125"
            />
            {/* Rotating SVG CAD blueprint circles - styled responsively in CSS */}
            <svg className="cad-blueprint" viewBox="0 0 200 200">
              {/* Axis Grid Lines */}
            ...
            <p className="loader-text text-xs font-mono tracking-[0.4em] uppercase text-accent animate-pulse font-bold" style={{ color: '#DC143C', textShadow: '0_0_15px_rgba(220,20,60,0.7)' }}>
